                ...
                <form action="display.php" method = "POST">
                    ...
                    <div class="form-group">
                        ...
                        <div class="custom-control custom-control-inline custom-radio">
                            <input name = "gender" value = "male" type="radio" class="custom-control-input" id="male">
                            <label class="custom-control-label" for="male">Male</label>
                        </div>
                        <div class="custom-control custom-control-inline custom-radio">
                            <input name = "gender" value = "female" type="radio" class="custom-control-input" id="female">
                    ...
                    <div class="form-group">
                        ...
                        <div class="custom-control custom-checkbox">
                            <input name = "check[]" value = "Google Chrome" type="checkbox" class="custom-control-input" id="chrome">
                            <label class="custom-control-label" for="chrome">Google Chrome</label>
                        </div>
                        <div class="custom-control custom-checkbox">
                            <input name = "check[]" value = "Firefox" type="checkbox" class="custom-control-input" id="ff">
                            <label class="custom-control-label" for="ff">Firefox</label>
                        </div>
                        <div class="custom-control custom-checkbox">
                            <input name = "check[]" value = "Safari" type="checkbox" class="custom-control-input" id="safari">
                            <label class="custom-control-label" for="safari">Safari</label>
                        </div>
                        <div class="custom-control custom-checkbox">
                            <input name = "check[]" value = "Edge" type="checkbox" class="custom-control-input" id="edge">
                    ...
                    <button class="btn btn-primary px-5 mr-2">Send</button>
